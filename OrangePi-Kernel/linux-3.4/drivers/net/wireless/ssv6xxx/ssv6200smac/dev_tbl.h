...
u16 generic_deci_tbl[] = {
	...
	SET_DEC_TBL(0x0b, 0x3f, ACTION_SIGNAL_ACK, FRAME_ACCEPT),
	SET_DEC_TBL(0x01, 0x3d, ACTION_SIGNAL_ACK, FRAME_ACCEPT),
    /* a */ SET_DEC_TBL(0x00, 0x00, ACTION_DO_NOTHING, FRAME_ACCEPT),
	SET_DEC_TBL(0x00, 0x00, ACTION_SIGNAL_ACK, FRAME_ACCEPT),
	SET_DEC_TBL(0x00, 0x00, ACTION_DO_NOTHING, FRAME_DROP),
	SET_DEC_TBL(0x00, 0x00, ACTION_UPDATE_NAV, FRAME_DROP),
	SET_DEC_TBL(0x00, 0x00, ACTION_RESET_NAV, FRAME_DROP),
	...
	0x2008,
	0x1001,
            0x0400, // 2 - 0000 1000 0000 0000 - Mcast or Bcast data/mgmt frames with same or wildcard BSSID.
            0x0400, // 3 - 0000 1000 0000 0000 - Mcast or Bcast data/mgmt frames with different BSSID. To support dual interface, accept as BSSID matched.
	0x2000,
	0x800E,
	0x0800,
	0x0B88,
...
static u32 phy_info_tbl[] =
	...
	SET_PHY_INFO(314, 0, 0, 0, 0),  SET_PHY_INFO(258, 0, 1, 0, 0),
	SET_PHY_INFO(223, 0, 1, 0, 0),  SET_PHY_INFO(213, 0, 1, 0, 0),
	SET_PHY_INFO(162, 0, 4, 0, 0),  SET_PHY_INFO(127, 0, 4, 0, 0),
	SET_PHY_INFO(117, 0, 4, 0, 0),  SET_PHY_INFO(60, 7, 7, 0, 0),
	SET_PHY_INFO(52, 7, 7, 0, 0),   SET_PHY_INFO(48, 9, 9, 0, 0),
	SET_PHY_INFO(44, 9, 9, 0, 0),   SET_PHY_INFO(44, 11, 11, 0, 0),
	SET_PHY_INFO(40, 11, 11, 0, 0), SET_PHY_INFO(40, 11, 11, 0, 0),
	SET_PHY_INFO(40, 11, 11, 0, 0), SET_PHY_INFO(76, 7, 7, 0, 1),
	SET_PHY_INFO(64, 9, 9, 1, 1),   SET_PHY_INFO(60, 9, 9, 2, 1),
	SET_PHY_INFO(60, 11, 11, 3, 1), SET_PHY_INFO(56, 11, 11, 4, 1),
	SET_PHY_INFO(56, 11, 11, 5, 1), SET_PHY_INFO(56, 11, 11, 5, 1),
	SET_PHY_INFO(56, 11, 11, 5, 1), SET_PHY_INFO(76, 7, 7, 6, 1),
	SET_PHY_INFO(64, 9, 9, 1, 1),   SET_PHY_INFO(60, 9, 9, 2, 1),
	SET_PHY_INFO(60, 11, 11, 3, 1), SET_PHY_INFO(56, 11, 11, 4, 1),
	SET_PHY_INFO(56, 11, 11, 5, 1), SET_PHY_INFO(56, 11, 11, 5, 1),
	SET_PHY_INFO(56, 11, 11, 5, 1), SET_PHY_INFO(64, 7, 7, 0, 0),
	SET_PHY_INFO(52, 9, 9, 0, 0),   SET_PHY_INFO(48, 9, 9, 0, 0),
	SET_PHY_INFO(48, 11, 11, 0, 0), SET_PHY_INFO(44, 11, 11, 0, 0),
	SET_PHY_INFO(44, 11, 11, 0, 0), SET_PHY_INFO(44, 11, 11, 0, 0),
	SET_PHY_INFO(44, 11, 11, 0, 0), SET_PHY_L_LENGTH(50, 38, 35),
	SET_PHY_L_LENGTH(35, 29, 26),   SET_PHY_L_LENGTH(29, 26, 23),
	SET_PHY_L_LENGTH(26, 23, 23),   SET_PHY_L_LENGTH(23, 23, 20),
	SET_PHY_L_LENGTH(23, 20, 20),   SET_PHY_L_LENGTH(47, 38, 35),
