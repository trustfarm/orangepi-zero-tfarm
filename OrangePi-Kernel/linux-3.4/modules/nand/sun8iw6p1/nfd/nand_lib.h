...
struct _nftl_blk {
	...
	int (*write_data) (struct _nftl_blk *nftl_blk,
...
extern __s32 PHY_SimpleWrite_CFG(struct boot_physical_param *writeop,
				 struct boot_ndfc_cfg *ndfc_cfg);
extern __s32 PHY_SimpleRead_CFG(struct boot_physical_param *readop,
				struct boot_ndfc_cfg *ndfc_cfg);
