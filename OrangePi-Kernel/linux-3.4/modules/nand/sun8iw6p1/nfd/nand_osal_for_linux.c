...
#define  NAND_DRV_VERSION_1		0x2b
#define  NAND_DRV_DATE			0x20160911
#define  NAND_DRV_TIME			0x1845
...
__s32 NAND_AllocMemoryForDMADescs(__u32 *cpu_addr, __u32 *phy_addr)
{
	...
	p = (void *)dma_alloc_coherent(NULL, PAGE_SIZE, (dma_addr_t *)&physical_addr, GFP_KERNEL);
...
__u32 NAND_GetNandExtPara(__u32 para_num)
{
	...
	if (para_num == 0) {
		type =
		    script_get_item("nand0_para", "nand_p0", &nand_para);
